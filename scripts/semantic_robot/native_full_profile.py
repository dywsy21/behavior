...
NAME = 'a100_full_v1'
DEPENDENCY_FILES = (
    'native_full_profile.py', 'launch_h69.py', 'launch_h70.py', 'launch_h71.py', 'launch_h73.py', 'probe_scene_compatible_cameras.py',
...
def checked_helpers():
    ...
    for filename in DEPENDENCY_FILES:
        if filename in ('native_full_profile.py', 'launch_h69.py', 'launch_h70.py', 'launch_h71.py', 'launch_h73.py'):
            continue
