...
- `/mnt/sdc1/robodojo/behavior_dev/a4_radio_full_20260913_v1`：A4＋B-final自主完整收音机三实例评测，public_test301/302/303；不是有前缀的L1。11:39编排PID1479480已启动，Git worktree `/mnt/sdc1/robodojo/behavior_dev/git_worktrees/a4_radio_full_20260913`固定be23b06，不热pull。`manifest.json`固定条件，`instance_301/`等各保留结果/视频，`summary.json`仅结束后生成；新专用服务8783/8784，结束仅关闭自身子进程。真实结果见plan。
