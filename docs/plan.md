...
- **原队列/同步：** CoT正式2032144于19:16实查32/500、512抽取，EMA1707751→tail1820879仍原等待，不重排；marker十窗已完成且未胜FM，不再扩该候选物理。代码在feature；本轮文档/结果正在独立main工作树同步，主代码整合仍待独立review。整体goal继续，不能把本CPU审计当容量训练效果或最终完成。
