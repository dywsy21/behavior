...
18:22更正（0模型/训练前）：独审指出i194/f1547右腕只见灰色壁与橙色碎片，主代理第5张原图复查确认不足单图识别桶，P→U；总P43/N54/U11，train32/41/8、val11/13/3。原采集图不变，标签修订保留Git，不用另一视角或时序倒推。原“4张原图”是18:10当时计数。
