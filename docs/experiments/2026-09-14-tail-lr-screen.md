...
**2026-09-14 19:30真实状态：原1820879已于19:18:21因EMA前驱未完成而退出，0 smoke/0 formal更新；连锁起因为CoT遭外部人工kill，不是尾端LR训练失败。以下18:10“等待”为历史状态。** 旧v1不覆盖、不重排；先协调GPU使用，再登记尚未执行预算的恢复入口。详见[人工停止诊断](2026-09-14-cot-external-stop.md)，当前没有v2或新训练。

2026-09-14 17:58北京时间预登记，owner Codex。**18:10已核验唯一等待器1820879，0GPU/0更新。** source `2300c50ac83c47f2e8df01f1691e514383bbbc71`、299 CPU通过；spec `55bdce00df92b30b8d75dd3b465134e4dc9664907037de64a558cc22a55932d4`。唯一候选`fm_tail_lr_v1`，不是泛化超参搜索，不重复已完成control/其他方法。[机器摘要](results/2026-09-14-tail-lr-screen.json)。
...
18:06：source `2300c50ac83c47f2e8df01f1691e514383bbbc71`，独立`git_worktrees/tail_lr_screen_20260914`真实299 CPU passed（4.05s），含35新用例。实际PyTorch/玩具Adam共500步的各组LR恒定父末值，原默认500的参数/Adam及LR逐位不变，200点磁盘恢复继续到500精确重现。默认预更新LR和约0.0027245，候选约0.0005，是暴露量记录而非真实更新倍率；未做policy/GPU-DDP效果验证。唯一tail run正按原预登记预算提交等待原EMA，回执待验。

18:10：18:07:06唯一提交1820879，18:09实查PID/argv/status为等待EMA1707751/ticks336359196（EMA原spec d195fd58…），无GPU/更新。launch SHA `6f4ca2522dd63e75048a4659fd439c5e9f4c63bead4bc6bc139353233d176f32`。该源现在活跃，不能pull；不在下一goal轮重新提交或重跑CPU/父状态检查。实际显存/五步保存门和正式500收益仍待原队列推进。
