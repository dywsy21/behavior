...
| AR-01 | 纯AR是否能学会且自由解码正确 | 原生/当前训练接口、codec/schema/完整动作组、自由生成而非仅teacher-forcing；短训后局部闭环 | 两种旧AR500均完成但自由0/5完整；marker500/193 Adam/8000及完整保存passed（3801388d…），最终CE4.6194、自由5/5完整，非内容收益/SR/部署。唯一最终十窗配对2021126正在执行（81810be/42 CPU，10 AR/0训练仿真），与M04 FM实际输入指纹对比。schema旧十窗/native448＋256及29视图已完成不重复。原CoT220792已smoke2019434（d114581/5＋500），EMA/tail原等待，不重排；内容/闭环验收未完 |
