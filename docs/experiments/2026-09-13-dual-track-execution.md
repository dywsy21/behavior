...
| AR-01 | 纯AR是否能学会且自由解码正确 | 原生/当前训练接口、codec/schema/完整动作组、自由生成而非仅teacher-forcing；短训后局部闭环 | 两种AR500均完成但自由0/5完整；marker193 Adam/5门passed，正式1563012最近264/500，100→200自由完整0/5→2/5，200 CE4.9585；两完整样本RMSE仍约1.505/1.002，不是SR/可直接部署，原500未完。schema十窗内容FM胜7/10；native唯一448＋256物理及29视图审查完成，未抓住/非持续绕圈，不重复。原CoT220792仍等marker（d114581/165 CPU，5＋500），无CoT正式结果，不重排；下一内容/闭环验收 |
