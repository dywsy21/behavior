...
| AR-01 | 纯AR是否能学会且自由解码正确 | 原生/当前训练接口、codec/schema/完整动作组、自由生成而非仅teacher-forcing；短训后局部闭环 | A4-AR500完整/CE6.7695但自由0/5；原生task已200/500。共享marker行20步配对改善缓存CE/标记rank但仍漏body；独立schema推理变体在CPU验收。正式CoT/marker训练与实际闭环仍未完成 |
