...
| M-04 | 离散动作监督及梯度隔离是否有效 | 区分纯FM、CE+FM无隔离、CE+FM有隔离；同数据来源，先梯度/无泄漏和可学习性门 | FM/joint均完整500与十窗实际输入配对通过（d3502794…/3e1f5eb6…）；joint固定80高0.96%、heldout前段动作RMSE高2.59%，不选新默认/不扩radio。原30生成已用20、剩余KI10，须待其500保存；KI16:23实际304/500。全局裁剪耦合有日志证据但未证明根因，未启动新配方；最终方法/兼容与闭环尚未验收 |
| AR-01 | 纯AR是否能学会且自由解码正确 | 原生/当前训练接口、codec/schema/完整动作组、自由生成而非仅teacher-forcing；短训后局部闭环 | 两种AR500均完成但自由0/5完整；marker v3 4129562已真实等待KI，原5＋500尚未训练。schema十窗内容FM胜7/10；native观察/神经/wire/socket及唯一448＋256物理回合已完成，全动作/96锚点/18物理事件/29视图审查通过。短预算未抓住、手臂近保持、非持续绕圈；不是完整SR/等预算对照，不追加此回合。唯一native Subtask-CoT220792已真实等待marker，d114581/165 CPU、原5＋500/原native-task500对照、不重做工程门；当前0更新，勿重复提交 |
