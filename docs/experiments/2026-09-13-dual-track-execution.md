...
| AR-01 | 纯AR是否能学会且自由解码正确 | 原生/当前训练接口、codec/schema/完整动作组、自由生成而非仅teacher-forcing；短训后局部闭环 | A4-AR500完成/回读通过，固定80 CE6.7695但自由0/5完整组；原生task-AR进入四卡smoke。CoT两更新门通过但亦缺组，正式CoT训练及闭环仍待完成 |
