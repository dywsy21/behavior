...
19:27补充：真实四进程训练读取已验证256不同TRAIN窗口/768当前RGB、182实例，包含全TRAIN最短/最长1242/2481-token序列，32.907秒完成，0模型/训练。精确采样与32更新GPU容量基准入口已固定9c38fec；详情见[训练容量验证](2026-09-26-h85-training-capacity.md)。CPU准备完成，下一等四卡队友任务自然退出后实测GPU，不重复构造数据或用CPU速度外推训练容量。
