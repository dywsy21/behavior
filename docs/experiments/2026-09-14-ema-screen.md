...
**2026-09-14 19:30真实状态：原1707751已于19:18:13因CoT前驱遭外部人工kill而退出，0 smoke/0 formal更新；不是EMA配方的训练失败。以下17:46“等待”是历史状态。** 原v1保留，不重启或覆盖；恢复GPU使用须先与用户/相关账号协调，之后再显式记录尚未执行预算和新前驱。详见[人工停止诊断](2026-09-14-cot-external-stop.md)，尚未登记或实现v2恢复。
