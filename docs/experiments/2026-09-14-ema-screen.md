...
2026-09-14 17:31北京时间预登记，owner Codex，feature `feat/dual-track-fm-ar-20260913`。**当前仅准备实现，尚未排队或训练，source commit待提交固定。** 已完成库时钟检查见[前置证据](2026-09-14-ema-preflight.md)，不重复该小例子。
...
- 唯一run拟为`robo:/mnt/sdc1/robodojo/behavior_dev/dual_track_fm_ar_20260913/fm_trainable_ema_v1`；从A4-2500 `6186704788c27c9fae3502c884df0e259de5242ee8690fe578dcbc1f2632f269`重新初始化、新Adam，不接CoT或smoke权重。
