# H81：扩数据前的视觉定位teacher校准（已结束，标签质量失败）

最终 source `be1aca51430126061f03826ed4b0d3b332c4ac60`，监管 completed/exit0/345.811s，97 生成、0 更新/控制；GPU2 进程峰 55,478MiB、退出后自有资源释放。81 格式全合法，但正确 41/81（50.62%），P recall12/32、N24/41、U5/8。P预测12全对，N预测35仅24对，U预测34仅5对；16重复可见性相同，只有14份框完全相同，两份有小幅批相关坐标漂移。**不能给H80扩标或释放长训数据。**

本人全部81原图、12正例13框已检查，记录 `configs/vlm_sft/h81_parent_teacher_review_v1.json`；框定位对应物体但部分近景粗糙，无IoU金标。不更改H76冻结人审标签。独立审查按冻结源 CPU/offline 重放 validator 通过，只验收证据完整性，语义质量不通过。

完整结果留远端原 run，本地7件小包 `artifacts/agentic-vlm-goal-20260918/h81_grounding_results_v1`；predictions SHA `64a4c1c90e43e5a0d78d052187ef5e9a7e276c9face4bfeb7cba00f3fd459565`。下一H82另登记训练参考图域校准，不重启H81。

以下是运行前登记，保留历史，不代表仍待启动。
